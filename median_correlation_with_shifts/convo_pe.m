...
outpath = '/data/nil-external/dcl/Events152_fMRI_NeuralMechanisms/voxelwiseAnalyses/matlab_resampling2/out_convo_pe/';
...
for rid = 1:4    % rid = 1; 
    infname = [inpath  runids{rid} '_avg_pe.csv'];  % input filename
